"""Tests for build_optimiser.contributors."""
...
def make_commits_df() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        "contributor": [
            ...
            "alice@co.com", "alice@co.com", "alice@co.com",
            "bob@co.com", "bob@co.com", "bob@co.com",
            # Team B: works on target_3 and target_4
            "carol@co.com", "carol@co.com", "carol@co.com",
            "dave@co.com", "dave@co.com", "dave@co.com",
            # Drive-by contributor (below threshold)
            "eve@co.com",
        ],
        "cmake_target": [
            "target_1", "target_2", "target_1",
            "target_1", "target_2", "target_2",
            "target_3", "target_4", "target_3",
            "target_3", "target_4", "target_4",
            "target_1",
        ],
        "commit_count": [
            10, 8, 5,
