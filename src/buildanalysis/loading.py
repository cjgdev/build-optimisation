...
class FileMetricsSchema(pa.DataFrameModel):
    ...
    compiler_parse_time_ms: Series[float] = pa.Field(nullable=True, ge=0)
    compiler_template_instantiation_ms: Series[float] = pa.Field(nullable=True, ge=0)
    compiler_codegen_time_ms: Series[float] = pa.Field(nullable=True, ge=0)
    compiler_optimization_time_ms: Series[float] = pa.Field(nullable=True, ge=0)
    compiler_total_time_ms: Series[float] = pa.Field(nullable=True, ge=0)
    compiler_total_usr_ms: Series[float] = pa.Field(nullable=True, ge=0)
    compiler_total_sys_ms: Series[float] = pa.Field(nullable=True, ge=0)
...
class TargetMetricsSchema(pa.DataFrameModel):
    ...
    compiler_parse_time_sum_ms: Series[float] = pa.Field(ge=0)
    compiler_template_time_sum_ms: Series[float] = pa.Field(ge=0)
    compiler_codegen_phase_sum_ms: Series[float] = pa.Field(ge=0)
    compiler_optimization_time_sum_ms: Series[float] = pa.Field(ge=0)
    compiler_total_usr_sum_ms: Series[float] = pa.Field(ge=0)
    compiler_total_sys_sum_ms: Series[float] = pa.Field(ge=0)
